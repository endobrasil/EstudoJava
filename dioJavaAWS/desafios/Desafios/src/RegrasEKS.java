/**
 * Descrição
 * Você é um engenheiro responsável por ajudar as equipes de desenvolvimento
 * a calcular o número mínimo de nodes e servidores necessários para
 * suportar seus aplicativos no cluster do EKS..
 *
 * Regras Básicas:
 *
 * Cada node pode suportar até 10 pods.
 * Cada servidor (EC2) pode suportar até 4 pods.
 * Seu objetivo é desenvolver um programa em Java que permita
 * ao usuário fazer uma consulta de dimensionamento.
 * O programa deve receber o número total de pods do aplicativo e calcular
 * o número mínimo de nodes e servidores necessários com base nas regras de dimensionamento.
 *
 * Aqui estão as etapas que você deve seguir:
 *
 * 1. Inicialização:
 *
 * Defina as regras básicas de dimensionamento,
 * ou seja, a capacidade de pods por node e pods por servidor.
 *
 ...
 * 3. Cálculo:
 *
 * Calcule o número mínimo de nodes necessários, arredondando para cima o resultado
 * da divisão do número total de pods pelo número de pods por node.
 * Calcule o número mínimo de servidores necessários, arredondando para cima o resultado
 * da divisão do número total de pods pelo número de pods por servidor.
 *
 * 5. Recomendações:
 *
...
public class RegrasEKS {
    public static void main(String[] args) {
        ...
        double numeroPodes = new Double(numeroTotalPods);



        //TODO: Calcule o número mínimo de nodes necessários
        double numeroMinimoNodes =Math.ceil(numeroPodes/podsPorNode);

        //TODO: Calcule o número mínimo de servidores necessários
        double numeroMinimoServidores =Math.ceil(numeroPodes/podsPorServidor);


                //TODO: Exiba o resultado com as recomendações de quantidades de servidores e nodes.

        if(numeroMinimoNodes==1){
            System.out.printf("1.Recomendamos usar um unico node");
        }else {
            System.out.printf("1.Numero minimo de nodes:%.0f",numeroMinimoNodes);
        }

        if(numeroMinimoServidores==1){
            System.out.printf("\n2.Recomendamos usar um unico servidor");
        }else {
            System.out.printf("\n2.Numero minimo de servidores:%.0f",numeroMinimoServidores);
        }
