/**
 * Descrição
 * você é um jovem engenheiro de software recém-contratado pela empresa
 * "TechCloud". Sua equipe é responsável por desenvolver aplicativos
 * e serviços que serão implantados na Amazon Web Services (AWS),
 * a principal plataforma de computação em nuvem do mercado.
 *
 * Sua primeira tarefa é desenvolver um programa simples em Java que
 * auxilie os desenvolvedores a calcular os custos de execução de seus
 * aplicativos na AWS. Para isso, você precisa coletar algumas informações e
 * aplicar uma fórmula para determinar o custo total.
 *
 ...
 *
 * O programa deve solicitar ao usuário a quantidade de servidores e a
 * quantidade de bancos de dados que o aplicativo necessita para funcionar corretamente.
 *
 * 3. Calcule os custos:
 *
 * Multiplique a quantidade de servidores pelo custo por hora de um servidor e a
 * quantidade de bancos de dados pelo custo por hora de um banco de dados.
 * Some esses valores para obter o custo total.
 *
 * 4. Exiba o resultado:
 *
 * Mostre ao usuário o custo total do uso da AWS para executar o
 * aplicativo durante uma hora.
 *
 * Entrada
 * O programa deverá receber duas entradas,
 * a primeira será referente a quantidade de servidores necessários.
 * A segunda entrada será referente a quantidade de banco de dados necessários.
 *
...
public class CalculandoCustosAWS {
    public static void main(String[] args) {
        ...
        double custoTotal = custoPorHoraBancoDados*quantidadeBancosDados+custoPorHoraServidor*quantidadeServidores;
