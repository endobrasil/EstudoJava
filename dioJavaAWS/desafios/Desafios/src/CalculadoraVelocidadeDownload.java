 ...
 * E sua tarefa será criar uma calculadora de velocidade de download
 * que leve em consideração a localização geográfica do servidor de origem e do
 * dispositivo do usuário. Quanto mais próximo o servidor, menor será a latência e,
 * portanto, a velocidade de download será melhor.
 * Isso permitirá que os usuários estimem a velocidade de download para
 * diferentes locais e servidores AWS em todo o mundo.
 *
 ...
 * Saída
 * A calculadora deve fornecer a estimativa da velocidade de download (em Mbps) com base na fórmula
 * de cálculo que considera a distância física e a velocidade do plano de internet.
 *
 * Entrada	Saída
 * 200
 * 50       16.67
